# preventing error messages while running the script
...
$appsbloat = @(
    ...
    "Microsoft.BingWeather", "Microsoft.BingFoodAndDrink",
    ...
    "Microsoft.ConnectivityStore", "Microsoft.CommsPhone",
    "Microsoft.Getstarted", "Microsoft.MicrosoftOfficeHub","*ActiproSoftwareLLC*", "*AdobeSystemsIncorporated.AdobePhotoshopExpress*","*PandoraMediaInc*", "*CandyCrush*",
    "*BubbleWitch3Saga*", "*Wunderlist*", "*Flipboard*", "*Twitter*",
    "*Facebook*", "*Royal Revolt*", "*Sway*", "*Speed Test*", "*Dolby*",
    "*Viber*", "*ACGMediaPlayer*", "*Netflix*", "*OneCalendar*","*AdobePhotoshopExpress*", "*HotspotShieldFreeVPN*",
...
foreach ($app in $appsbloat) {
    Get-AppxPackage -Name $app| Remove-AppxPackage
    Get-AppxProvisionedPackage -Online | Where-Object DisplayName -like $app | Remove-AppxProvisionedPackage -Online
}

# Disable Services
foreach ($service in $servicebloat) {
...
# Install Windows Terminal and set it as default 
